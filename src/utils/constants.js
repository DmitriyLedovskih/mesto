...
export const formElementDelete = document.querySelector('.popup__form_type_delete');
export const formButtonDelete = document.querySelector('.popup__form-button_type_delete');
...
export const formButtonAvatar = document.querySelector('.popup__form-button_type_avatar');
...
export const formButtonAdd = document.querySelector('.popup__form-button_type_add');
